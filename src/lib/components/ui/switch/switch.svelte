...
>
  <SwitchPrimitive.Thumb
    ...
    class={cn(
      'bg-background dark:data-[state=unchecked]:bg-text-disabled dark:data-[state=checked]:bg-primary-foreground pointer-events-none block size-4 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%+4px)] data-[state=unchecked]:translate-x-1',
    )}
  />
</SwitchPrimitive.Root>
