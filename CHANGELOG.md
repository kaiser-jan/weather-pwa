# [1.2.0](https://github.com/kaiser-jan/weather-pwa/compare/v1.1.0...v1.2.0) (2025-08-31)


### Bug Fixes

* **chart:** axis pointer not always snapping to nearest value ([8fa0915](https://github.com/kaiser-jan/weather-pwa/commit/8fa091514f40655a9e753dde3f758db94ccb66a9))
* **chart:** axis side alternation ignoring hidden axis ([cfc863e](https://github.com/kaiser-jan/weather-pwa/commit/cfc863e4021ca9605f9712c93960fdcdda8942fd))
...
* **chart:** snap axis pointer to nearest previous point ([258382f](https://github.com/kaiser-jan/weather-pwa/commit/258382f5eeadd5708b94baeb6ef11550ecad82cc))
...
* **data:** respect timezone for day start/end timestamp again ([cbe0874](https://github.com/kaiser-jan/weather-pwa/commit/cbe087478721cf4be6a74be1a42ddf8d1c233fb3))
* **data:** reverse dataset order to correctly respect priorities ([3808701](https://github.com/kaiser-jan/weather-pwa/commit/3808701860b4b4b5d0ff8029a4e5800ac294424c))
* **data:** store not refreshing on new data ([3dc44b2](https://github.com/kaiser-jan/weather-pwa/commit/3dc44b261aa47a6000e1774d9e4a67fed3dedcee))
...
* **day:** make day view navigation more reliable ([9f2ea15](https://github.com/kaiser-jan/weather-pwa/commit/9f2ea15b0596202897f1604b060dd46265fd3f13))
...
* **day:** still show metrics even if no value is available ([9370515](https://github.com/kaiser-jan/weather-pwa/commit/9370515dab8c13a8c14628cbf048a1cfe6a67da7))
...
* **geosphere.at:** nowcast incorrect base forecast age ([27d8ae4](https://github.com/kaiser-jan/weather-pwa/commit/27d8ae408b28d42c7e0c870bc179cdab483fa420))
...
* **insights:** show when precipitationGroup reaches end of data ([9e64d72](https://github.com/kaiser-jan/weather-pwa/commit/9e64d729f5d5efd228937519c7255e0f209a1a88))
...
* **loaders:** throw on response not ok ([4d0c839](https://github.com/kaiser-jan/weather-pwa/commit/4d0c8393a2ad6d5389ecbd7bb43483810ca42461))
...
* **pwa:** keep update notification infinitely ([d1ef3e4](https://github.com/kaiser-jan/weather-pwa/commit/d1ef3e4b994690659ffb85437b4e4d63fff50f7a))
...
* **settings:** groups would open as separate pages ([ea0d8e7](https://github.com/kaiser-jan/weather-pwa/commit/ea0d8e754fdb1a71ad18d5b0e8148c5f1915a6f4))
* **settings:** navigating into groups broken due to throttle ([9e3293c](https://github.com/kaiser-jan/weather-pwa/commit/9e3293c58794a44c3ef15ac5e9dc8e0e125b7655))
...
* **settings:** value display item not displaying ([78a3dff](https://github.com/kaiser-jan/weather-pwa/commit/78a3dff36b64ab5ca8cb44b70ccbcd7487327d17))
...
* **ui:** add active styles to buttons ([eccfc51](https://github.com/kaiser-jan/weather-pwa/commit/eccfc5196336b3b5a0789ca385fb68c3c5ad3360))
...
* various small fixes ([0b9f66c](https://github.com/kaiser-jan/weather-pwa/commit/0b9f66c12f1578fc2fef38f89507f6192b727934))


### Features

* **chart:** add empty placeholder ([85f01a1](https://github.com/kaiser-jan/weather-pwa/commit/85f01a197c898a6a28b43d9d361699aac33db6f3))
...
* **chart:** auto alternate side of axis ([f4bdd2e](https://github.com/kaiser-jan/weather-pwa/commit/f4bdd2e45f4c4b70960c1fb360ab7279962a1e25))
...
* **chart:** merge equal axis ([21ee19a](https://github.com/kaiser-jan/weather-pwa/commit/21ee19a8a8785fa17e262b6e15a63451f3634aeb))
...
* **day:** make chart metrics depend on context or setting ([b8c7a75](https://github.com/kaiser-jan/weather-pwa/commit/b8c7a752a3a1cce5eac04d49727c3bd14d765f77))
* **day:** support hiding metrics in accordion ([955b5a8](https://github.com/kaiser-jan/weather-pwa/commit/955b5a833e714ace7e7ea4c5047cb5a850b6231c))
...
* **error:** add error boundary with resolution instructions ([57280c6](https://github.com/kaiser-jan/weather-pwa/commit/57280c645dc49da4ade27b101ab51335ddd83ff2))
* **error:** add fail safe wrappers to sections and views ([85b30a9](https://github.com/kaiser-jan/weather-pwa/commit/85b30a91ba7a1ce5adbf91b8b3dd2aa8a4ebeccb))
...
* **geosphere.at:** add support for chem-v2-1h-3km and chem-v2-1h-9km ([7c6d686](https://github.com/kaiser-jan/weather-pwa/commit/7c6d6863384061fcea96586be99ef6b081f39dcc))
* **geosphere.at:** add support for inca historical analysis ([6a4e324](https://github.com/kaiser-jan/weather-pwa/commit/6a4e3246bdbeede82767422c16080debb249eb7f))
* **loaders:** better integrated sources section ([80709d0](https://github.com/kaiser-jan/weather-pwa/commit/80709d0499d99a7bbc0dfe251ba1f4f33e572242))
* **loaders:** do not update forecastStore on cache hit ([6b19d00](https://github.com/kaiser-jan/weather-pwa/commit/6b19d0011fefe2924b90970e797566104d7a105e))
* **loaders:** show outdated in sources section ([adaf990](https://github.com/kaiser-jan/weather-pwa/commit/adaf990c355a1d7acb234475ee39d27f53b65594))
* **loaders:** upgrade status display to table including datetimes ([609e03e](https://github.com/kaiser-jan/weather-pwa/commit/609e03e36d16503c240bbd1e17d03e231d6ff1c9))
...
* **playground:** leafletjs map to visualize dataset coverageArea ([a246a1d](https://github.com/kaiser-jan/weather-pwa/commit/a246a1d7865ff654726daaba1fee5e6f0246cdeb))
* **playground:** show selected location on map ([a999db7](https://github.com/kaiser-jan/weather-pwa/commit/a999db77105af0d0b560ba084d52116c6de5d629))
...
* **providers:** auto-select datasets based on location ([7a64948](https://github.com/kaiser-jan/weather-pwa/commit/7a64948b38cd21df7f466a2091557ab8f9f276bd))
* **providers:** display data sources with links and loading states ([ccfe649](https://github.com/kaiser-jan/weather-pwa/commit/ccfe6493da354dfc3cabf16ab09f642edb79e76d))
* **sections:** add air pollution section ([5afc553](https://github.com/kaiser-jan/weather-pwa/commit/5afc553a696e7ca91cab2a4cd1a250595b3ddbda))
* **sections:** better distinguish days as click targets ([dd5c071](https://github.com/kaiser-jan/weather-pwa/commit/dd5c07150b3a19a68cd731cc05babd9698a18069))
...
* **timeline-bar:** only show sun when there is cloud data ([d792b31](https://github.com/kaiser-jan/weather-pwa/commit/d792b31bfce03b890ed2f70c8cdaca021c51706a))
* **ux:** various smaller improvements and fixes ([3a02063](https://github.com/kaiser-jan/weather-pwa/commit/3a02063bbdd86dc6f368574a87a689518b0a6a27))
...
* **data:** use timestamp instead of DateTime everywhere ([d887bc6](https://github.com/kaiser-jan/weather-pwa/commit/d887bc6e50a527de0192728ce35f9dcdc309fc8c))
* directly provide current datetime as timestamp ([b7931b4](https://github.com/kaiser-jan/weather-pwa/commit/b7931b473099fa6320a4058b6466c8678b257516))
